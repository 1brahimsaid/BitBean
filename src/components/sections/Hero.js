        ...
        <div className={innerClasses}>
          <div className="hero-content">
            <h1 className="mt-0 mb-16 reveal-from-bottom" data-reveal-delay="200">
              Fantom <span className="text-color-primary">BitBean</span>
            </h1>
            <div className="container-xs">
              <p className="m-0 mb-32 reveal-from-bottom" data-reveal-delay="400">
              <span className="text-color-primary">BitBean</span> is Fantom's newest self-destructing currency, equipped with airdropped staking rewards for holders and future on-chain governance.
                </p>
          ...
          <div className="hero-figure reveal-from-bottom illustration-element-01" data-reveal-value="20px" data-reveal-delay="800">
            <a
              data-video="https://player.vimeo.com/video/584596870"
              href="#0"
          ...
          <Modal
            ...
            video="https://player.vimeo.com/video/584596870"
            videoTag="iframe" />
        </div>
      </div>
    </section>
